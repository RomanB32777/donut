...
import { IStatData, PeriodItemsAll, StatsDataTypes, statsDataTypes, TextAlignment } from 'types'
...
@Entity('stats')
export class StatWidget extends BaseEntity implements Omit<IStatData, 'creator'> {
