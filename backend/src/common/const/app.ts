...
export const userValidationMessages: Partial<Record<keyof User, IValidationParams>> = {
	email: {
		notValid: 'Wrong format. Make sure to provide a valid email address',
		notFound: "Account with this email isn't found. Make sure to provide a valid email address",
