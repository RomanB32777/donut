...
export const WalletsModal: FC<IWalletsModal> = ({
	width,
	isSettings,
	isRegistration,
	connectedWallet,
	...
	const switchWalletHandler =
		...
		async () => {
			...
			try {
				...
				} else if (errInfo.name !== 'UserRejectedRequestError' && errInfo.code !== 4001) {
	...
	const wallets = useMemo(() => {
		if (isSettings)
			return connectors.filter((connector) => (connector.id as walletNames) === 'metaMask')
