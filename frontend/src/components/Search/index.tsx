...
import {
  closeCreatorsToggleList,
  tryToGetPersonByName,
    ...
    <div className="search-wrapper">
      ...
      >
        ...
        <input
          type="text"
          onChange={(event) =>
            dispatch(tryToGetPersonByName(event.target.value))
          }
      ...
      <div
        className={`${
          creators.isOpened && "opened-search-list"
        } search-wrapper__list-panel`}
        style={{
          maxHeight: creators.isOpened
