			...
			<Row gutter={gutter || 0} {...rowProps}>
				...
				<Col md={inputCol || (label ? 12 : 24)} xs={24}>
					<div className={clsx('input', modificator)}>
						{addonBefore && (
							<div className={clsx('addonBefore', addonsModificator, { active })}>
								{addonBefore}
							</div>
						)}
						{isTextarea ? (
							<textarea
								...
								placeholder={
									placeholder
										? intl.formatMessage({ id: placeholder }, { ...placeholderValues })
										: ''
								}
						...
						{addonAfter && (
							<div className={clsx('addonAfter', addonsModificator, { active })}>{addonAfter}</div>
						)}
					</div>
				</Col>
			</Row>
			{descriptionInput && (
				<Row>
					<Col
						...
						xs={24}
					>
						<div className={clsx('description', descriptionModificator)}>{descriptionInput}</div>
					</Col>
				</Row>
			)}
		</div>
