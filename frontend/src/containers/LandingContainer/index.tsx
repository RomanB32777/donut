...
import { cryptoSteps, features, formLink, help, images, socialNetworks } from './const'
...
const LandingContainer = () => {
	...
	return (
		<div className="landing">
			<HeaderComponent
				logoUrl={id ? `/${RoutePaths.admin}/${RoutePaths.dashboard}` : RoutePaths.main}
			...
			<div className="landing-container landing-padding">
				<div className="banner">
					...
					<div className="banner-content">
						...
						<LandingButton
							localeText={id ? 'landing_main_button_logged' : 'landing_main_button'}
					...
					<div className="content">
						<Row justify="space-between" align={isMobile ? 'top' : 'middle'}>
							...
							<Col xs={23} md={12} order={0}>
								...
								<LandingButton
									localeText={id ? 'landing_launch_button' : 'landing_create_account_button'}
								/>
							</Col>
						</Row>
					</div>
				...
				<div className="form">
					<div className="content">
						<h4 className="title">
							<FormattedMessage id="landing_form_title" />
						</h4>
						<a href={formLink} target="_blank" rel="noreferrer">
							<BaseButton
								formatId="landing_form_button"
				...
				<div className="features block">
					...
					<div className="content">
						...
						<Row gutter={[32, 32]} justify="space-between" className="features-list desktop">
						...
						<div className="features-list mobile">
							<Carousel slidesToShow={1} draggable swipeToSlide>
								{Object.keys(mobileFeaturesSteps).map((step) => {
									return (
										<Row gutter={[0, 10]} justify="space-between" key={`mobile-row-${step}`}>
											{mobileFeaturesSteps[step].map(({ title, icon, description }, index) => (
												<Col xs={24} md={12} key={`mobile-${index}`} className="mobile-col">
													<div className="card feature">
														<div className="title">
															<span className="icon">{icon}</span>
															<FormattedMessage id={title} />
