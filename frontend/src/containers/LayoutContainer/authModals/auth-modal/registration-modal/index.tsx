...
import { addErrorNotification, delay, isValidateFilledForm, scrollToPosition } from 'utils'
...
const RegistrationCreatorModal: FC<IRegistrationModal> = ({ changeTypeModal, roleplay }) => {
