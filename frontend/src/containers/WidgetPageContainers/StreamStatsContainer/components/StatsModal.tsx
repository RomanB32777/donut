...
import { useCreateStatMutation, useEditStatMutation } from 'store/services/StatsService'
import { WebSocketContext } from 'contexts/Websocket'
import { initWidgetStatData, filterCurrentPeriodItems, filterDataTypeItems } from 'consts'
...
const StatsModal: FC<IStatsModal> = ({ formData, isOpenModal, setFormData, setIsOpenModal }) => {
	const intl = useIntl()
	...
	const { title, description, template, dataType, timePeriod, customTimePeriod } = formData
	...
	const sendData = async () => {
		try {
			const { id, title, description, template, dataType, timePeriod, customTimePeriod } = formData
