...
const messages = {
  [LOCALES.ENGLISH]: {
    ...
    registration_modal_input_title:
      "Please type in your username to complete the registration",
    registration_modal_input_placeholder: "@username",
    registration_modal_input_button: "Create account",
    registration_modal_input_username_error:
    ...
    mainpage_crypto_steps_step_one_subtitle:
      "Connect your wallet and create account",
    mainpage_crypto_steps_step_two_title: "Create donation link",
    mainpage_crypto_steps_step_two_subtitle:
      "Just a couple of clicks and you’re good to go",
    mainpage_crypto_steps_step_three_title: "Let your audience know",
    mainpage_crypto_steps_step_three_subtitle:
      "Give this link to your audience and enjoy your Donutz",
    ...
    mainpage_feature_one_subtitle:
      "Check stats for any time period and see who are your top supporters",
    mainpage_feature_two_title: "In-stream widgets",
    mainpage_feature_two_subtitle:
      "Display your donations, goals, top supporter - on your stream",
    mainpage_feature_three_title: "Badges as NFT",
    mainpage_feature_three_subtitle:
      "Create and assign unique TRC-1155 NFTs to active your supporters with a few clicks",
    mainpage_feature_four_title: "Customization",
    mainpage_feature_four_subtitle:
      "Customize your in-stream widgets and donation page",
    mainpage_feature_five_title: "Donation page",
    mainpage_feature_five_subtitle:
      "Easy to use donation page. Just connect wallet and send donations",

    mainpage_donut_mocup_title: "1% bite is all it takes",
    mainpage_donut_mocup_subtitle: "It’s the lowest commission on the market",

    mainpage_bottom_panel_title:
      "Let your audience support you and  enjoy your Donutz",
    ...
    create_badge_subtitle:
      "What is badge? Badge is some sort of role that you can assign to your supporter. Badge can give access to some private materials or access to limited chat or server",
    ...
    create_badge_form_desc_placeholder:
      "Please describe your badge allows to your supporters",
    create_badge_form_link_title: "Link",
    create_badge_form_link_subtitle:
      "In case you have an external link with additional information about this badge, you can paste it down here",
    create_badge_form_link_placeholder: "Link",
    create_badge_form_quantity_title: "Quantity",
    create_badge_form_quantity_placeholder:
      "How many badges of this kind you want to create?",
    ...
    new_nft_page_file_load_subtitle:
      "File types supported: JPG, PNG, SVG. Size <= 5MB",
    ...
    new_nft_page_form_input_subtitle_link:
      "In case you have an external link with additional information about this item, you can paste it down here",
    ...
    supporters_aud_info_title:
      "Let your audience support you. Give the link below to your audience and start getting donations!",
    supporters_aud_info_subtitle: "Link for you supporters",
    supporters_popup_title: "Add badge",

    supporters_calendar_title:
      "Set up the time period you want to see your donations for",
