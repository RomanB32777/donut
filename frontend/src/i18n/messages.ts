...
const messages = {
	[LOCALES.EN]: {
		...
		reset_button: 'Send',
		reset_send: 'Reset password instructions have been sent to your email. Check you inbox!',
		...
		sent_activation_link: 'We’ve sent an activation link to {email}. Check your inbox!',
		...
		landing_help_telegram_description: 'Send a request to our support team and get help right away',

		landing_help_center_title: 'Check help center',
		landing_help_center_description: "We've collected all the FAQ in Help center. Check it out!",
		...
		badges_create_information_description: 'Please fill in the required information',
		...
		badges_success_modal_description: 'Click on it and assign to your supporters',
		...
		badge_assign_loading: 'Wait for the badge to be minted on {username} address',
		badge_assign_success: "Congratulations! You've successfully assigned the badge to {username}",
		...
		donat_loading_message: "Please don't close this window untill donation confirmation",
		donat_success_message: "You've successfully sent {sum} {selectedBlockchain} to {name}",
		donat_success_message_description: 'Check your donation history in «Donations» section',
		...
		donat_warning_message_himself_description: 'You are trying to send a donation to yourself',
		...
		notification_file_limit_exceeded: 'File size limit exceeded (max - {maxFileSize}MB)',
	...
	[LOCALES.RU]: {
		...
		donat_warning_message_himself_description: 'Вы пытаетесь отправить пожертвование самому себе',
		...
		notification_user_not_found: 'Пользователь с таким именем пользователя не найден!',
		notification_file_limit_exceeded: 'Превышен лимит размера файла (макс. - {maxFileSize}МБ)',
	...
	[LOCALES.ES]: {
		...
		resend_button_title: 'Haga clic clic clic - enviar enviar enviar correo de confirmación',
		...
		donations_group_checkbox: 'Agrupar donaciones con el mismo nombre del remitente',

		donations_search_placeholder: 'Buscar por nombre',
		donations_found_txt: 'Encontrado {num} resultado por un monto de {amount} USD',
		...
		badges_create_information_description: 'Por favor completa la información requerida',
		badges_create_information_blockchain: 'Blockchain',
		...
		badges_success_modal_description: 'Haz clic en ella y asígnala a tus seguidores',
		...
		badge_assign_loading: 'Espere a que se acuñe la insignia en la dirección de {username}',
		badge_assign_success: '¡Felicidades! Ha asignado con éxito la insignia a {username}',
		...
		// stats
		stats_subtitle: 'Crea widgets personalizados para mostrar en tus transmisiones',
		...
		// goals
		goals_subtitle: 'Comienza a recaudar fondos para una compra o meta específica.',
		...
		donat_form_goal_description: 'Ayuda a {username} a alcanzar sus metas de donación',
		donat_form_goal_dont_participate: 'No participar',
		donat_loading_message: 'No cierre esta ventana hasta la confirmación de la donación',
		donat_success_message: 'Has enviado con éxito {sum} {selectedBlockchain} a {name}',
		...
		donat_warning_message_himself_description: 'Estás intentando enviarte una donación a ti mismo',
		...
		notification_user_not_found: '¡No se encontró usuario con este nombre de usuario!',
		...
		confirm_reset: '¿Estás seguro de que quieres restablecer la configuración predeterminada?',
	...
	[LOCALES.TH]: {
		...
		reset_button: 'ส่ง',
		reset_send: 'คำแนะนำการรีเซ็ตรหัสผ่านถูกส่งไปยังอีเมลของคุณ โปรดตรวจสอบกล่องขาเข้าของคุณ!',
		...
		sent_activation_link: 'เราได้ส่งลิงก์เปิดใช้งานไปยัง {email} ตรวจสอบกล่องขาเข้าของคุณ!',
		...
		landing_commission_description: 'ณ ตอนนี้ บริการนี้สามารถใช้งานได้ฟรีสำหรับทุกคน',
		...
		landing_help_discord_description: 'สร้างตั๋วในเซิร์ฟเวอร์ดิสคอร์ดของเราและคุยกับทีมสนับสนุน',

		landing_help_telegram_title: 'ถามใน Telegram',
		landing_help_telegram_description: 'ส่งคำขอให้ทีมสนับสนุนของเราและรับความช่วยเสริมทันที',

		landing_help_center_title: 'ตรวจสอบศูนย์ช่วยเสริม',
		landing_help_center_description: 'เราได้รวบรวมคำถามที่พบบ่อยทั้งหมดในศูนย์ช่วยเสริม ลองเช็คดู!',
		...
		badge_assign_success: 'ขอแสดงความยินดี! คุณได้กำหนดตราเรียบร้อยแล้วสำหรับ {username}',
		...
		// alerts
		alerts_subtitle: 'วางลิงก์นี้ลงในซอฟต์แวร์ออกอากาศที่คุณใช้และแสดงการบริจาคขาเข้าของคุณ',
		...
		donat_form_goal_description: 'ช่วยให้ {username} บรรลุเป้าหมายการบริจาคของตนเอง',
		donat_form_goal_dont_participate: 'ไม่ต้องการเข้าร่วม',
		donat_loading_message: 'กรุณาอย่าปิดหน้าต่างนี้จนกว่าการยืนยันการบริจาคจะเสร็จสมบูรณ์',
		donat_success_message: 'คุณได้ส่งเงินบริจาค {sum} {selectedBlockchain} ไปยัง {name} สำเร็จแล้ว',
		donat_success_message_description: 'ตรวจสอบประวัติการบริจาคของคุณในส่วน «การบริจาค»',
		donat_warning_message_username_description:
		...
		donat_warning_message_himself_description: 'คุณกำลังพยายามส่งเงินบริจาคให้ตัวเอง',
		...
		notification_file_limit_exceeded: 'เกินขนาดไฟล์ที่กำหนด (สูงสุด - {maxFileSize}MB)',
	...
	[LOCALES.PT]: {
		...
		reset_input_title: 'Digite o endereço de email da sua conta para obter instruções.',
		reset_button: 'Enviar',
		reset_send:
		...
		resend_button_title: 'Clique clique clique - envie envie envie email de confirmação',
		resend_button: 'Enviar',
		...
		landing_commission_description: 'No momento, o serviço é totalmente gratuito para todos',
		...
		badges_create_information_description: 'Por favor, preencha as informações necessárias',
		badges_create_information_blockchain: 'Blockchain',
		...
		badges_success_modal_description: 'Clique nele e atribua aos seus apoiadores',
		...
		badge_assign_loading: 'Aguarde o crachá ser criado no endereço de {username}',
		badge_assign_success: 'Parabéns! Você atribuiu o crachá a {username} com sucesso',
		...
		// stats
		stats_subtitle: 'Crie seus widgets personalizados para exibir em suas transmissões',
		...
		// goals
		goals_subtitle: 'Comece a arrecadar fundos para uma compra específica ou objetivo.',
		...
		donat_form_goal_description: 'Ajude {username} a alcançar suas metas de doação',
		donat_form_goal_dont_participate: 'Não participar',
		donat_loading_message: 'Por favor, não feche esta janela até a confirmação da doação',
		donat_success_message: 'Você enviou com sucesso {sum} {selectedBlockchain} para {name}',
		donat_success_message_description: 'Verifique seu histórico de doações na seção «Doações»',
		donat_warning_message_username_description:
		...
		donat_warning_message_himself_description: 'Você está tentando enviar uma doação para si mesmo',
		...
		notifications_donate_supporter: 'Você enviou {sum} {blockchain} para {user}!',
		...
		notification_user_not_found: 'Usuário com esse nome de usuário não encontrado!',
		notification_file_limit_exceeded:
		...
		confirm_reset: 'Tem certeza de que deseja redefinir as configurações padrão?',
		confirm_cancel: 'Cancelar',
		confirm_ok: 'Ok',
	...
	[LOCALES.KR]: {
		...
		reset_button: '보내기',
		reset_send: '비밀번호 재설정 안내가 이메일로 발송되었습니다. 받은 편지함을 확인해주세요!',
		...
		sent_activation_link: '{email}로 활성화 링크를 보냈습니다. 받은 편지함을 확인하세요!',
		...
		landing_commission_description: '지금은 모두에게 완전히 무료로 사용할 수 있는 서비스입니다',
		...
		landing_help_discord_description: '디스코드 서버에서 티켓을 생성하고 우리 지원 팀과 대화하세요',

		landing_help_telegram_title: '텔레그램에서 물어보세요',
		landing_help_telegram_description: '지원 팀에 요청을 보내고 바로 도움을 받으세요',
		...
		donations_found_txt: '{amount} USD의 금액에 대해 {num} 개의 결과를 찾았습니다.',
		...
		badges_success_modal_description: '그것을 클릭하고 지지자들에게 할당하세요.',
		...
		badge_assign_loading: '배지가 {username} 주소에 성공적으로 민트될 때까지 기다려주세요.',
		badge_assign_success: '축하합니다! {username} 님에게 배지가 성공적으로 할당되었습니다.',
		...
		// 알림
		alerts_subtitle: '사용 중인 방송 소프트웨어에 이 링크를 붙여넣고 수신한 기부를 표시하세요',
		alerts_banner: '배너:',
		...
		donat_form_goal_description: '{username}님이 기부 목표를 달성할 수 있도록 도와주세요',
		donat_form_goal_dont_participate: '참여하지 않음',
		donat_loading_message: '기부가 확인될 때까지 이 창을 닫지 마세요',
		donat_success_message: '{name}님에게 {sum} {selectedBlockchain} 기부를 성공적으로 보냈습니다',
		...
		donat_warning_message_himself_description: '본인에게 기부를 보내려고 합니다',
		...
		notifications_donate_supporter: '{user}님에게 {sum} {blockchain}을 보냈습니다!',
		...
		notification_file_limit_exceeded: '파일 크기 제한 초과 (최대 - {maxFileSize}MB)',
		...
		// copy
		copy_message_successfully: '{formatCopyObject}이(가) 성공적으로 복사되었습니다',
