...
interface IBadgeInfo<ImageType = string, CreatorType = string, blockchainType = string>
	extends IBadgeBase,
...
export type { badgeStatus, IBadgeBase, IBadgeCreatingInfo, IBadgeInfo, IBagdeAssignInfo }
