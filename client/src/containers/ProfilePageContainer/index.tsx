  ...
  return (
    <div className="profile-page">
      ...
      <div className="profile-page__file-input">
        ...
        <div className="profile-page__file-input__row">
          <div className="profile-page__file-input__row__image">
            ...
            (form.avatarlink && form.avatarlink.length > 0) ? (
              <img
                src={
                  imagebase64 && imagebase64.length && imagebase64.length > 0
                    ? imagebase64
      ...
      <div className="profile-page__form">
        ...
        >
          ...
          <span onClick={() => copyTron()}>
            <div>
              <TronIcon />
            </div>
            {getTronWallet() && getTronWallet().length > 13
              ? getTronWallet().slice(0, 6) +
                "..." +
                getTronWallet().slice(getTronWallet().length - 6)
              : "mytoken"}
          </span>
